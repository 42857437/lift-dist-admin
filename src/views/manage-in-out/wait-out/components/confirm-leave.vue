    ...
    <div class="zzc" v-if="confirmLeave">
      <form action="" class="addform">
        ...
        <div class="form_item mtp10">
          <button class="serachBtn" type="button" @click="confirmSave">确认</button>
  ...
  export default {
    ...
    methods:{
      ...
      save(){
        ...
        // this.leaveModel.outUserid=this.outUserid;
        console.log(this.enterId1);
        this.$axios.post('/record/entry/update/3',{enterId:this.enterId1}).then(res=>{
          let data = this.AppUtils.checkResponse(res);
          console.log(data);
          if(data) {
            this.$message.success('取消放行成功');
            this.$emit('changeConfirm');
            this.$emit('relod');
          }
        })
